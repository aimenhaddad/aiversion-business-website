        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 my-2">
                    ...
                    <div class="mx-3 text-success "><span class=" h2">
                        ...
                        <form action="database/insert_order.php" method="post" class="well form-horizontal">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-2 col-md-6">
                                    ...
                                    <div class=" inputGroupContainer">
                                        <div class="input-group-prepend "><input id="fullName"
                                                style="border-radius: 20px; padding-left: 10px;" type="text" name="Name_Client"
                                                placeholder="Full Name" class="form-control" required="true" value="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-2 col-md-6">
                                    ...
                                    <div class=" inputGroupContainer">
                                        <div class="input-group-prepend">
                                            <input id="phone" type="text" style="border-radius: 20px; padding-left: 10px;"
                                                name="Phone_Client" placeholder="Phone" class="form-control"
                                                required="true" value="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="form-group mt-3 col-md-8  ">
                                    <select name="City" class="form-control " style="border-radius: 20px; padding-left: 10px;">
                                ...
                                <div class="col-md-4  my-3 d-inline-flex  justify-content-center ">
                                    <button class="quantity-left-minus btn btn-danger btn-number btn-sm "
                                        data-type="minus" data-field="" style="border-radius: 50%;"> <i
                                            class="fa fa-minus"></i> </button>
                                    <input type="number" id="quantity" name="Qte" class=" text-center mx-1"
                                        style="border-radius: 25px;" value="1" min="1" max="100">
                                    <button class="quantity-right-plus btn btn-success btn-number btn-sm  "
                                        data-type="plus" data-field="" style="border-radius: 50%;"><i
                                            class="fa fa-plus"></i></button>
                                </div>
                            </div>
                            <div class="text-center">
                                <button class="btn btn-outline-primary  col-12 " style="border-radius: 25px;"
                    ...
                    <div class="">
                        ...
                        <p class="card-text mx-4 h6">
                            <?php echo $row["Description_Pro"] ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-6 mb-2">
                    ...
                    <img class="card-img-top " src="database/upload/<?php echo $row["image"] ?>" height="400px"
                        width="400px" alt="..." />
                </div>
            </div>
            <?php
